# DESAFIO PROGRAMA ESTÁGIO START DB ✅

Desafio realizado no processo seletivo para o programa de estágio da empresa [DB](https://db.gupy.io/).


### O DESAFIO - CAIXA DA LANCHONETE
